...
func addInitValues() string {
	log.Println("adding starting init")
	CLIENTS = Clients{File: CONF_FILE}
	CLIENTS.readFile()
	...
	PROXY = Proxy{adr: ":9999"}

	ROUTER = Router{Port: ":8080"}
	log.Println(SENTINEL, PROXY, KEYS, CLIENTS, ROUTER)
	return getEnv("redis.token", "d29bbdfd9f7c2b46d142590330f28ef9029da92a83c947b57924504fd7f4abc092a550eb868f3ebf2d7f152690de26e975cf991e7b5d47bdeabf8990c89d09ed32ee8e18ca7ae62d13fd302cfc2683c5e39e398c38cf2b0e82f7ff764b30a8af587b651a")
}
